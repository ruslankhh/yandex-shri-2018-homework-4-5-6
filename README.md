...
- UPD: Благодаря тестам нашёл ошибку — при получении содержимого файлов использовал не `ls-tree -t`, то есть с получением родительских папок. Что могло привести к некорректной работе.
