# Домашние задания "Node.js", "Инфраструктура" и "Интеграционное тестирование"
...
3. [Задание "Интеграционное тестирование"](#Задание-Интеграционное-тестирование)
...
- [ ] приложение показывает список веток, можно выбрать ветку
...
- [ ] одновременно отображается текущий уровень дерева файлов, можно перейти по ссылкам во вложенные папки или подняться на уровень выше
